...
const scene = makeScene2D('scene', function* (view) {
    const video: string = useScene().variables.get('video', undefined)()!;
    const words: Word[] = useScene().variables.get('words', undefined)()!;
    const duration = words[words.length-1].end + 0.5;
    const videoContainer = createRef<Layout>();
...
function* displayVideos(container: Reference<Layout>, video: string, totalDuration: number){
